// Kept in sync with electron-app/seed.js and prisma/seed.ts (same seed data,
// three different runtime contexts: dev/Prisma CLI, Electron+embedded-postgres,
// this Docker image's apt-installed postgres).
